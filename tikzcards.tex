...
\newcommand{\cardbackground}[1]{
  \fill[cardimage=#1] \shapeBackground;
}
...
\newcommand{\cardtitle}[1]{
  ...
  \node[align=center, text width=(\cardwidth-\stripwidth-2*\strippadding-2*\borderwidth-2*\textpadding)*1cm,font=\large] at (\titlex,\titley) {%
...
\newcommand{\cardcontent}[2]{
  ...
  \end{scope}
  \node[below right, align=justify, text width=(\cardwidth-2*\strippadding-\stripwidth-4*\textpadding-2*\borderwidth)*1cm] at (2*\strippadding+\stripwidth+\textpadding+\borderwidth,\cardheight-\strippadding-\borderwidth) {
